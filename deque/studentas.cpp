...
void Studentas::irasytiStudentuDuomenis(const std::string& failoPavadinimas, const std::deque<Studentas>& studentai) {
...
void Studentas::rikiuotiStudentus(std::deque<Studentas>& studentai, int rikiavimoPasirinkimas) {
