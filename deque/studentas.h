...
public:
    ...
    //klasės funkcijos
    static void irasytiStudentuDuomenis(const std::string& failoPavadinimas, const std::deque<Studentas>& studentai);
    static void rikiuotiStudentus(std::deque<Studentas>& studentai, int rikiavimoPasirinkimas);
};
