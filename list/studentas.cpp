...
void Studentas::irasytiStudentuDuomenis(const std::string& failoPavadinimas, const std::list<Studentas>& studentai) {
...
void Studentas::rikiuotiStudentus(std::list<Studentas>& studentai, int rikiavimoPasirinkimas) {
