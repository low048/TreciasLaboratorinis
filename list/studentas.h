...
public:
    ...
    //klasės funkcijos
    static void irasytiStudentuDuomenis(const std::string& failoPavadinimas, const std::list<Studentas>& studentai);
    static void rikiuotiStudentus(std::list<Studentas>& studentai, int rikiavimoPasirinkimas);
};
